...
const ICNpc BG_IC_NpcSpawnlocs[NPCS_MAX_SPAWNS]=
{
    ...
    /*{NPC_KOR_KRON_GUARD,TEAM_HORDE,1259.65f,-757.101f,49.0412f,3.07512f}, // 7
    {NPC_KOR_KRON_GUARD,TEAM_HORDE,1288.02f,-769.556f,50.9632f,3.13945f}, // 8
    {NPC_KOR_KRON_GUARD,TEAM_HORDE,1294.96f,-770.526f,70.0415f,0.0f}, // 9 
    {NPC_KOR_KRON_GUARD,TEAM_HORDE,1300.54f,-764.082f,50.7029f,2.89725f}, // 10 
    {NPC_KOR_KRON_GUARD,TEAM_HORDE,1300.87f,-757.958f,50.7029f,2.89725f}, // 11 
    {NPC_KOR_KRON_GUARD,TEAM_HORDE,1259.78f,-776.087f,49.0412f,3.64539f}, // 12
    {NPC_KOR_KRON_GUARD,TEAM_HORDE,1288.23f,-759.656f,50.9632f,3.27512f}, // 13
    {NPC_KOR_KRON_GUARD,TEAM_HORDE,1258.67f,-769.493f,49.0412f,3.06393f}, // 14
    {NPC_KOR_KRON_GUARD,TEAM_HORDE,1279.75f,-768.528f,50.9441f,2.80155f}, // 15*/
    ...
    /*{SEVEN_TH_LEGION_INFANTRY,TEAM_ALLIANCE,299.641f,-834.17f,49.0412f,3.09981f},// 20
    {SEVEN_TH_LEGION_INFANTRY,TEAM_ALLIANCE,300.0f,-828.646f,49.0412f,3.55773f},// 21 
    {SEVEN_TH_LEGION_INFANTRY,TEAM_ALLIANCE,224.377f,-827.401f,60.9034f,0.0f},// 22
    {SEVEN_TH_LEGION_INFANTRY,TEAM_ALLIANCE,319.545f,-825.262f,49.0412f,0.261493f},// 23*/
...
/*
    ...
    GO_DOODAD_ND_WINTERORC_WALL_GATEFX_DOOR01 // 86
};*/
